...
# warning. Render them from the tree the patcher actually shipped: that checks
# the macros and that they reached the printer's config directory in one go.
run "service macros render and park where they say" \
